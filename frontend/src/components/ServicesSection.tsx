...
export default function ServicesSection({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col" style={{ padding: 'clamp(40px, 60px, 80px) clamp(16px, 32px, 80px)' }}>
        {/* Header Section */}
        <div className={`text-center mb-16 ${isRTL ? 'text-right' : 'text-left'}`}>
         ...
         <div className="flex-1 flex items-center justify-center mb-12">
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 w-full max-w-none px-4 sm:px-8 lg:px-12">
            {displayServices.map((service, index) => (
               ...
               >
                 {/* Icon */}
                 <div className="flex items-center justify-center" style={{ width: 'clamp(40px, 48px, 56px)', height: 'clamp(40px, 48px, 56px)', marginBottom: 'clamp(12px, 16px, 20px)' }}>
