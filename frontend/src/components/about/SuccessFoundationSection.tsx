      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16 ${
            language === "ar" ? "lg:grid-flow-col-dense" : ""
          }`}
        >
          {/* Image - Position changes based on language */}
          <div
            className={`relative ${
              language === "ar" ? "lg:col-start-2" : "lg:col-start-1"
            }`}
          >
            <div
              ...
              style={{
                backgroundImage: visionMessage?.VisionImage?.url
                  ? `url(${buildImageUrl(visionMessage.VisionImage.url)})`
                  : "url(/aboutsec.jpg)",
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(193.07deg, rgba(217, 217, 217, 0.26) 9.42%, rgba(16, 92, 36, 0.38) 69.8%)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div
            className={`flex flex-col justify-center ${
              language === "ar" ? "lg:col-start-1" : "lg:col-start-2"
            }`}
          ...
          >
            ...
            >
              {visionMessage?.VisionDescription ||
                (language === "ar"
        ...
        >
          ...
          >
            ...
            >
              {visionMessage?.MessageDescription ||
                (language === "ar"
            ...
            <div
              ...
              style={{
                backgroundImage: visionMessage?.MessageImage?.url
                  ? `url(${buildImageUrl(visionMessage.MessageImage.url)})`
                  : "url(/aboutsec1.jpg)",
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat",
