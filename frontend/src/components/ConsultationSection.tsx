    ...
    <section className="py-16 lg:py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Contact Form */}
          <div className={`${language === 'ar' ? 'lg:order-2' : 'lg:order-2'} ${language === 'ar' ? 'lg:pr-8' : 'lg:pr-8'}`}>
          ...
          {/* Text Content */}
          <div className={`${language === 'ar' ? 'lg:order-1' : 'lg:order-1'} text-center ${language === 'ar' ? 'lg:text-right' : 'lg:text-left'} ${language === 'ar' ? 'lg:pl-8' : 'lg:pl-8'} bg-blue-50 p-6 rounded-lg`}>
            <h2 
            ...
            <p 
              className={`text-lg leading-relaxed text-gray-600 max-w-2xl mx-auto ${language === 'ar' ? 'lg:mx-0' : 'lg:mx-0'}`}
              style={{ fontFamily: 'var(--font-almarai)' }}
            >
              {language === 'ar' 
