...
const Footer = ({
  ...
  const defaultQuickLinks = [
    { ar: DICT.home[language], en: DICT.home[language], href: `/${locale}` },
    {
      ar: DICT.aboutUs[language],
      en: DICT.aboutUs[language],
      href: `/${locale}/about`,
    },
    {
      ar: DICT.offers[language],
      en: DICT.offers[language],
      href: `/${locale}/offers`,
    },
    {
    ...
    {
      ar: DICT.blog[language],
      en: DICT.blog[language],
      href: `/${locale}/blog`,
    },
    {
