...
/**
 * FAQ Structured Data Component (JSON-LD)
 */
  ...
  const schema = useMemo(
    () => ({
      ...
      mainEntity: items.map((item) => ({
        "@type": "Question",
        name: language === "ar" ? item.question.ar : item.question.en,
        acceptedAnswer: {
          "@type": "Answer",
          text: language === "ar" ? item.answer.ar : item.answer.en,
        },
      })),
...
export const FAQSection = ({ title, subtitle, faqs }: FAQSectionProps) => {
  ...
  const defaultFaqData = [
    {
      ...
      answer: {
        ar: "عادة من 3 إلى 5 أيام عمل، وقد يختلف الوقت حسب اكتمال المستندات والإجراءات المطلوبة.",
        en: "Usually 3 to 5 business days, and the time may vary depending on the completion of documents and required procedures.",
      },
    },
    {
      question: {
      ...
      answer: {
        ar: "لا، يمكن إنجاز جميع الإجراءات عن بُعد دون الحاجة للحضور شخصياً. نحن نتولى كل شيء نيابة عنك.",
        en: "No, all procedures can be completed remotely without the need to attend in person. We handle everything on your behalf.",
      },
    },
    {
      question: {
      ...
      answer: {
        ar: "نعم، السعر يشمل جميع الرسوم الحكومية والضرائب المطلوبة. لا توجد رسوم مخفية.",
        en: "Yes, the price includes all government fees and required taxes. There are no hidden fees.",
      },
    },
    {
      question: {
      ...
      answer: {
        ar: "نعم، يمكن تعديل بعض البيانات حسب طبيعة التعديل المطلوب. تواصل معنا لمعرفة التفاصيل.",
        en: "Yes, some data can be modified depending on the nature of the required modification. Contact us for details.",
      },
    },
    {
      question: {
      ...
      answer: {
        ar: "يمكنك متابعة طلبك من خلال رقم الطلب المرسل إليك عبر الرسائل النصية أو البريد الإلكتروني.",
        en: "You can track your order through the order number sent to you via text messages or email.",
      },
    },
    {
      question: {
      ...
      answer: {
        ar: "نقبل جميع طرق الدفع الإلكترونية، البطاقات الائتمانية، والتحويلات البنكية.",
        en: "We accept all electronic payment methods, credit cards, and bank transfers.",
      },
    },
  ];
  ...
  return (
    <>
      ...
      <FAQStructuredData items={faqData} language={language} />
