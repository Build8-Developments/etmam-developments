...
export default function ServicesSection({
  ...
  const displayServices: ServiceCard[] = graphqlServices || mockServices;
  ...
  const getIconComponent = (
    icon: string | ImageAsset | undefined,
    isActive: boolean
  ) => {
    const iconColor = isActive ? "#FFFFFF" : "#90C054";
    const iconSize = "clamp(20px, 24px, 28px)";

    // If icon is an ImageAsset object, extract the icon type from the URL or use a default
    let iconType = "marketing";
    if (typeof icon === "string") {
      iconType = icon;
    } else if (icon && typeof icon === "object" && "url" in icon) {
      // Extract icon type from URL or alternativeText if available
      iconType = icon.alternativeText || "marketing";
    }

    const iconPaths = {
      building:
        "M3 21H21V19L12 5L3 19V21ZM5 19H7V17H5V19ZM5 15H7V13H5V15ZM5 11H7V9H5V11ZM9 19H11V17H9V19ZM9 15H11V13H9V15ZM9 11H11V9H9V11ZM13 19H15V17H13V19ZM13 15H15V13H13V15ZM13 11H15V9H13V11ZM17 19H19V17H17V19ZM17 15H19V13H17V15ZM17 11H19V9H17V11Z",
      license:
        "M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20Z",
      consulting:
        "M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22 22 17.52 22 12 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z",
      accounting:
        "M7 4V2C7 1.45 7.45 1 8 1S9 1.45 9 2V4H15V2C15 1.45 15.45 1 16 1S17 1.45 17 2V4H20C20.55 4 21 4.45 21 5S20.55 6 20 6H19V19C19 20.1 18.1 21 17 21H7C5.9 21 5 20.1 5 19V6H4C3.45 6 3 5.55 3 5S3.45 4 4 4H7ZM7 6V19H17V6H7ZM9 8H15V10H9V8ZM9 12H15V14H9V12ZM9 16H15V18H9V16Z",
      ...
      marketing:
        "M12 2L13.09 8.26L22 9L13.09 9.74L12 16L10.91 9.74L2 9L10.91 8.26L12 2ZM12 4.5L11.5 7.5L8.5 8L11.5 8.5L12 11.5L12.5 8.5L15.5 8L12.5 7.5L12 4.5Z",
    };

    const path =
      iconPaths[iconType as keyof typeof iconPaths] || iconPaths.marketing;
  ...
  return (
    <section
      ...
      style={{
        ...
        background:
          "linear-gradient(223.26deg, rgba(19, 113, 67, 0.81) 24.24%, #9BE43F 138.37%)",
        opacity: 1,
    ...
    >
      ...
      <div
        ...
        style={{ padding: "clamp(20px, 40px, 80px) clamp(8px, 16px, 80px)" }}
      >
        {/* Header Section */}
