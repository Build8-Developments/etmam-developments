...
export default function AboutSection({
  ...
  const defaultStatLabel =
    language === "ar" ? "شراكة ناجحة" : "Successful Partnership";
  ...
  const defaultFeatures = [
    {
      ...
      description:
        language === "ar"
          ? "ان نسلم في بناء بيئة أعمال أكثر سهولة واحترافية."
          : "We believe in building a more accessible and professional business environment.",
    },
    {
      icon: "mission",
      ...
      description:
        language === "ar"
          ? "تبسيط الإجراءات، وتقديم قيمة حقيقية للعملاء."
          : "Simplify procedures and provide real value to clients.",
    },
  ];
          ...
          <div className={`${styles.aboutGrid} ${isRTL ? "" : ""}`}>
              ...
              <div className={styles.aboutImageFrame}>
                ...
                <div className={styles.aboutMainImage}>
                  <Image
                    src={
                      mainImage
                        ? buildImageUrl(mainImage.url)
                        : IMAGE_PATHS.blog.left
                    }
                ...
                <div className={styles.aboutOverlayImage}>
                  <div className={styles.aboutOverlayContent}>
                    <Image
                      src={
                        secondaryImage
                          ? buildImageUrl(secondaryImage.url)
                          : IMAGE_PATHS.blog.right
                      }
            ...
            >
              ...
              >
                ...
                <h2 className={styles.aboutTitle}>{title || defaultTitle}</h2>
                {isRTL ? <span className={styles.aboutTitleLine}></span> : null}
              </div>
              ...
              <div className={styles.aboutFeatures}>
                {displayFeatures.map((feature, idx) => (
                  <div
                    key={idx}
                    className={`${styles.aboutFeatureItem} ${
                      isRTL ? styles.rtl : styles.ltr
                    }`}
                  >
                    ...
                    <div className={styles.aboutFeatureContent}>
                      <h4
                        className={`${styles.aboutFeatureTitle} ${
                          isRTL ? styles.rtl : styles.ltr
                        }`}
                      >
                        {feature.title}
                      ...
                      <p
                        className={`${styles.aboutFeatureDescription} ${
                          isRTL ? styles.rtl : styles.ltr
                        }`}
                      >
                        {feature.description}
