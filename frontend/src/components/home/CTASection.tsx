          ...
          >
            ...
            <div
              ...
              style={{
                ...
                borderBottomRightRadius: isRTL
                  ...
                  : "0px",
                padding: isRTL
                  ? "clamp(20px, 4vw, 48px) clamp(12px, 3vw, 32px) clamp(20px, 4vw, 48px) clamp(20px, 5vw, 64px)"
                  : "clamp(20px, 4vw, 48px) clamp(20px, 5vw, 64px) clamp(20px, 4vw, 48px) clamp(12px, 3vw, 32px)",
                zIndex: 2,
              }}
            >
              {/* Text Content */}
              ...
              <Link
                ...
                className={`inline-flex items-center justify-center bg-white text-green-700 font-semibold rounded-xl shadow-lg transition-smooth hover-lift hover-glow transform ${
            ...
            <div
              ...
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(271.11deg, rgba(17, 97, 58, 0.15) -1.22%, rgba(17, 97, 58, 0.25) 99.15%)",
                borderTopRightRadius: isRTL
                  ? "0px"
                  : "clamp(16px, 2.5vw, 24px)",
                borderBottomRightRadius: isRTL
