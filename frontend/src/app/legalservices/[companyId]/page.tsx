...
import { Header, Footer, CTASection, ServicesGrid } from "@/components";
...
export default function CompanyServicesPage() {
    ...
    "ministry-industry": {
      ...
      services: [
        ...
        },
        {
          ...
          title:
            language === "ar" ? "العقود والاتفاقيات" : "Contracts & Agreements",
          description:
            language === "ar"
              ? "إعداد ومراجعة العقود والاتفاقيات التجارية"
              : "Preparation and review of commercial contracts and agreements",
          price:
            language === "ar" ? "يبدأ من 1000 ريال" : "Starting from 1000 SAR",
          duration:
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 1200 ريال" : "Starting from 1200 SAR",
          duration:
            language === "ar" ? "من 5 إلى 7 أيام عمل" : "5 to 7 business days",
          icon: "trademark",
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 800 ريال" : "Starting from 800 SAR",
          duration:
            language === "ar" ? "من 1 إلى 2 أيام عمل" : "1 to 2 business days",
          icon: "document",
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 3000 ريال" : "Starting from 3000 SAR",
          duration:
            language === "ar"
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 5000 ريال" : "Starting from 5000 SAR",
          duration:
            language === "ar"
              ? "من 10 إلى 15 يوم عمل"
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 1800 ريال" : "Starting from 1800 SAR",
          duration:
            language === "ar" ? "من 3 إلى 5 أيام عمل" : "3 to 5 business days",
          icon: "shipping",
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 2500 ريال" : "Starting from 2500 SAR",
          duration:
            language === "ar" ? "من 5 إلى 8 أيام عمل" : "5 to 8 business days",
          icon: "certificate",
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 2200 ريال" : "Starting from 2200 SAR",
          duration:
            language === "ar" ? "من 6 إلى 9 أيام عمل" : "6 to 9 business days",
          icon: "environment",
        },
      ],
    },
      ...
      services: [
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 800 ريال" : "Starting from 800 SAR",
          duration:
            language === "ar" ? "من 2 إلى 3 أيام عمل" : "2 to 3 business days",
          icon: "vat",
        },
        {
          id: "tax-consultation",
          title:
            language === "ar" ? "الاستشارات الضريبية" : "Tax Consultations",
          description:
            language === "ar"
        ...
        },
        {
          ...
          title:
            language === "ar" ? "النصائح الاستثمارية" : "Investment Advice",
          description:
            language === "ar"
          ...
          price:
            language === "ar" ? "يبدأ من 2500 ريال" : "Starting from 2500 SAR",
          duration:
            language === "ar" ? "من 4 إلى 6 أيام عمل" : "4 to 6 business days",
          icon: "investment",
        },
      ],
    },
    "ministry-labor": {
      ...
      services: [
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 600 ريال" : "Starting from 600 SAR",
          duration:
            language === "ar" ? "من 1 إلى 3 أيام عمل" : "1 to 3 business days",
          icon: "iqama",
        },
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 300 ريال" : "Starting from 300 SAR",
          duration:
            language === "ar" ? "من 1 إلى 2 أيام عمل" : "1 to 2 business days",
          icon: "insurance",
        },
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 400 ريال" : "Starting from 400 SAR",
          duration:
            language === "ar" ? "من 1 إلى 2 أيام عمل" : "1 to 2 business days",
          icon: "records",
        },
        ...
        },
        {
          ...
          title:
            language === "ar" ? "الإجراءات التأديبية" : "Disciplinary Actions",
          description:
            language === "ar"
      ...
      services: [
        ...
        },
        {
          ...
          price:
            language === "ar" ? "يبدأ من 2500 ريال" : "Starting from 2500 SAR",
          duration:
            language === "ar" ? "من 6 إلى 8 أيام عمل" : "6 to 8 business days",
          icon: "pharmacy",
        },
        {
          id: "medical-practice",
        ...
        },
        {
          ...
          title:
            language === "ar" ? "الاستشارات الصحية" : "Health Consultations",
          description:
            language === "ar"
  ...
  const company = companyData[companyId as string];
