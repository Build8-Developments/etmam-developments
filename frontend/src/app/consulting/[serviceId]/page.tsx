...
export default function ConsultingServiceDetailPage() {
  ...
  > = {
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "اختر الخدمة المطلوبة من قائمة خدماتنا"
              : "Choose the required service from our services list",
          icon: "choice",
        },
        {
          title:
          ...
          description:
            language === "ar"
              ? "املأ النموذج بالتفاصيل المطلوبة"
        ...
        },
        {
          ...
          description:
            language === "ar"
              ? "نبدأ العمل على خدمتك وتسليمها في الموعد المحدد"
              : "We start working on your service and deliver it on time",
          icon: "complete",
        },
      ],
    },
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "نقوم بتحليل شامل للوضع الحالي لأعمالك"
              : "We conduct a comprehensive analysis of your current business situation",
          icon: "analysis",
        },
        {
          title:
            language === "ar" ? "إعداد التوصيات" : "Prepare Recommendations",
          description:
            language === "ar"
              ? "نعد توصيات مخصصة لتحسين أدائك"
              : "We prepare customized recommendations to improve your performance",
        ...
        },
        {
          ...
          description:
            language === "ar"
              ? "نساعدك في تنفيذ التوصيات ومتابعة النتائج"
              : "We help you implement recommendations and track results",
          icon: "implementation",
        },
      ],
    },
    "financial-consulting": {
      ...
      duration:
        language === "ar" ? "من 1 إلى 3 أيام عمل" : "1 to 3 business days",
      icon: "dollar",
      features: [
        language === "ar"
          ? "تحليل مالي شامل"
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "نراجع البيانات المالية الحالية ونحلل الأداء"
              : "We review current financial data and analyze performance",
          icon: "review",
        },
        {
          title:
          ...
          description:
            language === "ar"
              ? "نعد توصيات مالية مخصصة لتحسين الأداء"
              : "We prepare customized financial recommendations to improve performance",
          icon: "financial-plan",
        },
        {
          title:
            language === "ar" ? "تنفيذ الاستراتيجية" : "Implement Strategy",
          description:
            language === "ar"
              ? "نساعدك في تنفيذ الاستراتيجية المالية الموصى بها"
              : "We help you implement the recommended financial strategy",
          icon: "strategy",
        },
      ],
    },
    "marketing-consulting": {
      title:
        language === "ar" ? "الاستشارات التسويقية" : "Marketing Consulting",
      description:
        language === "ar"
      ...
      duration:
        language === "ar" ? "من 3 إلى 6 أيام عمل" : "3 to 6 business days",
      icon: "megaphone",
      features: [
        language === "ar"
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "نحلل السوق والمنافسين ونحدد الفرص"
              : "We analyze the market and competitors and identify opportunities",
          icon: "market-analysis",
        },
        {
          title:
            language === "ar" ? "إعداد الاستراتيجية" : "Strategy Preparation",
          description:
            language === "ar"
              ? "نعد استراتيجية تسويقية مخصصة لأعمالك"
              : "We prepare a customized marketing strategy for your business",
          icon: "strategy-prep",
        },
        {
          title:
            language === "ar" ? "تنفيذ الحملات" : "Campaign Implementation",
          description:
            language === "ar"
              ? "نساعدك في تنفيذ الحملات التسويقية ومتابعة النتائج"
              : "We help you implement marketing campaigns and track results",
          icon: "campaign",
        },
      ],
    },
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "نقيم الوضع الإداري الحالي ونحدد نقاط التحسين"
              : "We assess the current administrative situation and identify improvement points",
          icon: "assessment",
        },
        {
          title:
            language === "ar"
              ...
              : "Administrative Plan Preparation",
          description:
            language === "ar"
              ? "نعد خطة إدارية شاملة لتطوير المؤسسة"
              : "We prepare a comprehensive administrative plan for institutional development",
          icon: "admin-plan",
        },
        {
          title:
            language === "ar" ? "تنفيذ التطوير" : "Development Implementation",
          description:
            language === "ar"
              ? "نساعدك في تنفيذ التطويرات الإدارية ومتابعة النتائج"
              : "We help you implement administrative developments and track results",
          icon: "development",
        },
      ],
    },
    "technical-consulting": {
      ...
      duration:
        language === "ar" ? "من 5 إلى 10 أيام عمل" : "5 to 10 business days",
      icon: "code",
      features: [
      ...
      steps: [
        {
          ...
          description:
            language === "ar"
              ? "نحلل الأنظمة التقنية الحالية ونحدد نقاط التحسين"
              : "We analyze current technical systems and identify improvement points",
        ...
        },
        {
          ...
          description:
            language === "ar"
              ? "نصمم حلول تقنية مخصصة لاحتياجاتك"
              : "We design customized technical solutions for your needs",
        ...
        },
        {
          ...
          description:
            language === "ar"
              ? "نساعدك في تنفيذ الحلول التقنية وتقديم الدعم المستمر"
              : "We help you implement technical solutions and provide continuous support",
