  ...
  const offerData = useMemo(() => {
    ...
    if (mockOfferData) {
      ...
      return {
        ...
        title:
          mockOfferData.title[language] ||
          mockOfferData.title.ar ||
          mockOfferData.title.en,
        subtitle:
          mockOfferData.subtitle[language] ||
          mockOfferData.subtitle.ar ||
          mockOfferData.subtitle.en,
        description:
          mockOfferData.description[language] ||
          mockOfferData.description.ar ||
          mockOfferData.description.en,
        ...
        benefits: mockOfferData.benefits?.map((benefit) => ({
          title:
            benefit.title[language] || benefit.title.ar || benefit.title.en,
          description:
        ...
        termsAndConditions:
          mockOfferData.termsAndConditions?.[language] ||
          mockOfferData.termsAndConditions?.ar ||
          mockOfferData.termsAndConditions?.en,
        callToAction: mockOfferData.callToAction
          ? {
              label:
                mockOfferData.callToAction.label[language] ||
                mockOfferData.callToAction.label.ar ||
                mockOfferData.callToAction.label.en,
            ...
            <div className="max-w-4xl mx-auto">
              ...
              {offer.description && (
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      richTextToHTML(offer.description) ||
                          ...
                          <Image
                            src={
                              ...
                              feature.icon.url.startsWith("/")
                                ? feature.icon.url
                                : buildImageUrl(feature.icon.url)
                            }
                    ...
                    {offer.benefits.map((benefit: any, index: number) => (
                      ...
                      >
                        {benefit.icon?.url ? (
                          <Image
                            src={
                              benefit.icon.url.startsWith("http") ||
                              benefit.icon.url.startsWith("/")
                                ? benefit.icon.url
                                : buildImageUrl(benefit.icon.url)
                            }
              ...
              {offer.callToAction && (
                <div className="text-center">
                  <Link
                    href={`/${locale}${offer.callToAction.href || "/contact"}`}
                    ...
                    style={{ fontFamily: "var(--font-almarai)" }}
                  >
                    {getLocalizedValue(offer.callToAction.label) ||
                      (language === "ar"
                        ? "احصل على العرض الآن"
                        : "Get Offer Now")}
                    <svg
