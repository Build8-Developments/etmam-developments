...
export default function CompanyServicesPage() {
  ...
  const company = useMemo(() => {
    // If we have category data, use it (even if subservices aren't loaded yet)
    if (categoryData) {
      const services = categorySubservices.map((sub: any) => {
        const periodText =
          language === "ar"
            ? `من ${sub.finishPeriodMin || 1} إلى ${
                sub.finishPeriodMax || 3
              } أيام عمل`
            : `${sub.finishPeriodMin || 1} to ${
                sub.finishPeriodMax || 3
              } business days`;
        ...
        const priceText =
          language === "ar"
            ...
            : `Starting from ${sub.startFromPrice || 500} ${
                sub.currency || "SAR"
              }`;
      ...
      console.log("Created company object from GraphQL:", {
        name: companyObj.name,
        servicesCount: companyObj.services.length,
        hasServices: companyObj.services.length > 0,
      });
      ...
      "ministry-industry": {
        ...
        services: [
          ...
          },
          {
            ...
            title:
              language === "ar" ? "استخراج التراخيص" : "License Extraction",
            description:
              language === "ar"
          ...
          },
          {
            ...
            title:
              language === "ar" ? "الترخيص البيئي" : "Environmental Permit",
            description:
              language === "ar"
      ...
      "ministry-commerce": {
        ...
        services: [
          ...
          },
          {
            ...
            title:
              language === "ar" ? "العقود التجارية" : "Commercial Contracts",
            description:
              language === "ar"
      ...
      "ministry-finance": {
        ...
        services: [
          ...
          },
          {
            ...
            title:
              language === "ar" ? "إعداد الميزانيات" : "Budget Preparation",
            description:
              language === "ar"
      ...
      "ministry-labor": {
        ...
        services: [
          ...
          },
          {
            id: "hr-consultation",
            title:
              language === "ar" ? "الاستشارات الإدارية" : "HR Consultations",
            description:
              language === "ar"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServicesGrid
        ...
        baseHref={`/${locale}/legalservices/${companyId}`}
      />
