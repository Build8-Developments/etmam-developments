            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-white">
                  ...
                  >
                    {L(privacyPolicyPageData?.Hero?.title) ||
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-almarai)" }}
                  >
                    {L(privacyPolicyPageData?.Hero?.subtitle) ||
                      (language === "ar"
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    {privacyPolicyPageData?.Hero?.secondaryButton && (
                      <Link
                        href={`/${locale}${
                          privacyPolicyPageData.Hero.secondaryButton.href ||
                          "/contact"
                        }`}
                        ...
                        style={{ fontFamily: "var(--font-almarai)" }}
                      >
                        {L(privacyPolicyPageData.Hero.secondaryButton.label) ||
                ...
                <div className="relative">
                  <div className="grid grid-cols-2 gap-4">
                    {/* Privacy Stats Cards */}
                    {privacyPolicyPageData?.Hero?.stats?.map(
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 mb-12 border border-gray-100">
                <div className="text-center mb-8">
                  ...
                  >
                    {L(privacyPolicyPageData?.privacy_policy?.title) ||
                      (language === "ar"
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-almarai)" }}
                  >
                    {L(privacyPolicyPageData?.privacy_policy?.subtitle) ||
                      (language === "ar"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                privacyPolicyPageData.privacy_policy.content.length > 0
                  ? privacyPolicyPageData.privacy_policy.content
