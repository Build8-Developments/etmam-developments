    ...
    if (blogPostsData && blogPostsData.length > 0) {
      return blogPostsData.map((post: any) => {
        ...
        return {
          ...
          author: {
            ar: post.blog_author?.name || "",
            en: post.blog_author?.name || "",
          },
          date: publishedDate,
          category: post.blog_category?.name || "all",
          featured: post.featured_post || false,
          comments:
            post.blog_comments?.filter((c: any) => c.approved).length || 0,
      ...
      const matchesSearch =
        ...
        searchTerms.every(
          (term) =>
            ...
            (post.tags &&
              post.tags[language] &&
              post.tags[language].some((tag: string) =>
              ...
              <div className="lg:col-span-1 order-1 lg:order-2">
                <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
                    <h3
                      className="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6 text-center"
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
