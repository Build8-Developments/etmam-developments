import { Header, Footer, ConsultationSection } from "@/components";
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-white">
                  ...
                  >
                    {L(termsConditionsPageData?.Hero?.title) ||
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-almarai)" }}
                  >
                    {L(termsConditionsPageData?.Hero?.subtitle) ||
                      (language === "ar"
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    {termsConditionsPageData?.Hero?.secondaryButton && (
                      <Link
                        href={`/${locale}${
                          termsConditionsPageData.Hero.secondaryButton.href ||
                          "/contact"
                        }`}
                      ...
                      >
                        {L(
                          termsConditionsPageData.Hero.secondaryButton.label
                        ) ||
                          (language === "ar"
                            ? "استشارة قانونية"
                            : "Legal Consultation")}
                ...
                <div className="relative">
                  <div className="grid grid-cols-2 gap-4">
                    {/* Legal Stats Cards */}
                    {termsConditionsPageData?.Hero?.stats?.map(
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 mb-12 border border-gray-100">
                <div className="text-center mb-8">
                  ...
                  >
                    {L(termsConditionsPageData?.privacy_policy?.title) ||
                      (language === "ar"
                        ? "شروط استخدام خدمات إتمام"
                        : "Terms for Using Etmam Services")}
                  </h2>
                  <p
                    className="text-lg text-gray-600 max-w-3xl mx-auto"
                    style={{ fontFamily: "var(--font-almarai)" }}
                  >
                    {L(termsConditionsPageData?.privacy_policy?.subtitle) ||
                      (language === "ar"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                termsConditionsPageData.privacy_policy.content.length > 0
                  ? termsConditionsPageData.privacy_policy.content
