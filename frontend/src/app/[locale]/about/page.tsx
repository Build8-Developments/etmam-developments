...
export default async function AboutPage({ params }: AboutPageProps) {
  ...
  // Fetch data from Strapi with locale from URL
                  ...
                  <div className="text-white">
                    ...
                    >
                      {aboutData?.Hero?.title ||
                        content.hero.title[validLocale]}
                    </h1>
                    ...
                    >
                      {aboutData?.Hero?.subtitle ||
                        content.hero.description[validLocale]}
                    </p>

                    <div className="flex flex-wrap gap-4">
                      <Link
                        href={
                          aboutData?.Hero?.primaryButton?.href ||
                          `/${validLocale}/legalservices`
                        }
                      ...
                      >
                        {aboutData?.Hero?.primaryButton?.label ||
                          content.hero.buttons.primary[validLocale]}
                      </Link>
                      <Link
                        href={
                          aboutData?.Hero?.secondaryButton?.href ||
                          `/${validLocale}/contact`
                        }
                      ...
                      >
                        {aboutData?.Hero?.secondaryButton?.label ||
                          content.hero.buttons.secondary[validLocale]}
                      </Link>
                    </div>
                  </div>
                        ...
                        <>
                          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-center">
                              ...
                              >
                                {
                                  content.hero.stats.companiesFounded[
                                    validLocale
                                  ]
                                }
                              </div>
                          ...
                          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-center">
                              ...
                              >
                                {
                                  content.hero.stats.yearsExperience[
                                    validLocale
                                  ]
                                }
                              </div>
                          ...
                          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-center">
                              ...
                              >
                                {
                                  content.hero.stats.satisfactionRate[
                                    validLocale
                                  ]
                                }
                              </div>
                          ...
                          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-center">
                              ...
                              >
                                {
                                  content.hero.stats.technicalSupport[
                                    validLocale
                                  ]
                                }
                              </div>
        ...
        <AnimatedSection animation="fadeInUp" delay={100}>
          <AboutSection
            ...
            ctaButton={{
              ...
              href:
                aboutData?.aboutUs?.ctaButton?.href ||
                `/${validLocale}/legalservices`,
            }}
          />
        </AnimatedSection>
