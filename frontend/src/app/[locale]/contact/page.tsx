              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-white">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    {contactPageData?.Hero?.secondaryButton && (
                      <Link
                        href={
                          contactPageData.Hero.secondaryButton.href ||
                          "tel:+012000000000"
                        }
                        ...
                        style={{ fontFamily: "var(--font-almarai)" }}
                      >
                        {contactPageData.Hero.secondaryButton.label ||
                ...
                <div className="relative">
                  <div className="grid grid-cols-2 gap-4">
                    {/* Contact Stats Cards */}
                    {contactPageData?.Hero?.stats?.map(
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl lg:max-w-none">
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background =
                        "linear-gradient(164.42deg, #026838 -88.26%, #026838 425.49%)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactPageData?.Contact_Info_Cards?.[0]?.label ||
                    ...
                    >
                      {contactInfoData?.phone_number ||
                        contactPageData?.Contact_Info_Cards?.[0]?.data ||
                        "+012000000000"}
                    </p>
                  </div>
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      const textElements =
                        e.currentTarget.querySelectorAll("h3, p");
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactPageData?.Contact_Info_Cards?.[1]?.label ||
                    ...
                    <p
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactInfoData?.whatsapp_number ||
                        contactPageData?.Contact_Info_Cards?.[1]?.data ||
                        "+012000000000"}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactPageData?.Contact_Info_Cards?.[2]?.label ||
                    ...
                    >
                      {contactInfoData?.email ||
                        contactPageData?.Contact_Info_Cards?.[2]?.data ||
                        "Etmam@gmail.com"}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactPageData?.Contact_Info_Cards?.[3]?.label ||
                        (language === "ar" ? "الموقع" : "Location")}
                    </h3>
                    <a
                      href={
                        contactInfoData?.location_link ||
                        contactPageData?.location_link ||
                        "#"
                      }
                      target="_blank"
                      ...
                      style={{ fontFamily: "var(--font-almarai)" }}
                    >
                      {contactPageData?.Contact_Info_Cards?.[3]?.data ||
                        (language === "ar"
                          ? "السعودية، الرياض"
                          : "Saudi Arabia, Riyadh")}
                    </a>
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 flex flex-col gap-2">
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.openstreetmap.org/?mlat=24.7136&mlon=46.6753&zoom=15",
                      "_blank"
                    )
                  }
                  title={
